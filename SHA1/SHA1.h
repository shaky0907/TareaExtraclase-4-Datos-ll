/**
 * Codigo basado en la implementacion de https://www.codeproject.com/Articles/2463/SHA1-A-C-Class-Implementation-of-the-SHA-1-Hash-A
 * Clase para realizar el hashing propuesto por el algoritmo de SHA1
 */
